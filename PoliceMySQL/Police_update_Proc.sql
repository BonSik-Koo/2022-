...
IN n_name varchar(10),IN n_birth date,
IN n_gender varchar(2),IN n_phone varchar(14),
IN u_rank varchar(10),IN n_address varchar(45),
IN s_name varchar(10),IN d_name varchar(10),
IN t_name varchar(10),IN n_user_id int
)
BEGIN
Update User u set name = n_name, birth = n_birth, gender = n_gender, 
phone = n_phone, 
